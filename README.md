...
실사 피팅에는 FASHN VTON과 CatVTON 공개 데모를 활용합니다. 전신 사진과 상품 사진의 상태, 옷이 겹쳐 있는 정도, 생성 모델의 특성에 따라 결과가 달라질 수 있습니다. 실제 옷의 사이즈나 착용감을 보장하거나 구매 적합성을 판단하는 기능은 포함되어 있지 않습니다.

FASHN VTON 1.5는 Apache 2.0 라이선스를 따릅니다. CatVTON의 코드, 체크포인트, 데모는 CC BY-NC-SA 4.0 라이선스로 비상업적 용도로만 사용할 수 있습니다.
출처: [FASHN VTON 1.5 (Hugging Face), CatVTON (GitHub)](https://huggingface.co/fashn-ai/fashn-vton-1.5, 
Zheng-Chong/CatVTON
